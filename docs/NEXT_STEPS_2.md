...
## 1 — Design the description override, then author the sector-OS bands *(override designed and the Corporate OS authored in v0.72.0, the Science OS in v0.73.0, the Robotics OS in v0.74.0, the Global Health OS in v0.75.0, the Multilateral OS in v0.76.0 — 2,500 rows; two sector packs remain, same shape, `tools/author_override.py`)*
