...
## 1 — Design the description override, then author the sector-OS bands *(override designed and the Corporate OS authored in v0.72.0, the Science OS in v0.73.0 — 1,000 rows; five sector packs remain, same shape, `tools/author_override.py`)*
