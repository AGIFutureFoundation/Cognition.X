...
**Dataset-wide:** descriptions 64% · band-suffix 47% · code+level 100% · shortest transfer check 14 chars.
...
- Rows whose band-suffix description was replaced by an authored band sentence: **1,500** across 3 pack(s) (Cognition.X : Corporate OS, Cognition.X : Robotics OS, Cognition.X : Science OS).
