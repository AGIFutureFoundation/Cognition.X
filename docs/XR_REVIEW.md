...
| Which engine? | **A small WebGL renderer of our own** (`tools/xr/engine.js`, ~400 lines), not three.js, Babylon or A-Frame | The CSP forbids loading them; bundling one adds 600 KB to six apps for boxes, quads and text. The scenes are simple by design. |
