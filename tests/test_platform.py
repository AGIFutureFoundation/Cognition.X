...
KNOWN_BAND_SUFFIX_ROWS = 8750       # 11,250 before tranche one (v0.65.0); 10,750; 10,250; 9,750 after tranche three (v0.67.0); 9,250 Corporate OS (v0.72.0); 8,750 Science OS (v0.73.0); the ratchet only falls
...
BAND_OVERRIDDEN_PACKS = {"Cognition.X : Corporate OS": (100, 500), "Cognition.X : Science OS": (100, 500)}
