...
UNBANDED_FILLED_PACKS = {"Future-Work", "Civic & Leadership", "Language, Culture & Communication", "Health & Community", "K–12", "Trade School", "Regional", "Cognition.X : Sapient OS", "Cognition.X : Robotics OS", "Cognition.X : Global Health OS", "Cognition.X : Multilateral OS", "Non-Profit Practice"}
